...
def prompt_ventas(
    ...
    system_prompt = (
        ...
        "1. CONFIRMACIÓN: Cuando el usuario exprese interés en comprar, confirma el producto exacto y cantidad\n"
        "2. VERIFICACIÓN DE STOCK: Confirma que hay stock suficiente y menciona cuánto hay disponible\n"
        "3. PREGUNTA ADICIONAL: '¿Deseas agregar algo más a tu pedido antes de proceder?'\n"
        "4. RECOLECCIÓN DE DATOS (solo después de confirmar que no desea nada más):\n"
        "   - Nombre completo\n"
        "   - Cédula\n"
        "   - Teléfono\n"
        "   - Dirección completa\n"
        ...
        "5. FINALIZACIÓN: Una vez recolectados TODOS los datos, responde: 'Tu pedido ha sido registrado exitosamente. Pronto te contactaremos para coordinar la entrega. ¡Gracias por confiar en {nombre_empresa}!'\n\n"
        "VALIDACIONES:\n"
